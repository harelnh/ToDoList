...
public class Test2_DateTimeTest extends ActivityInstrumentationTestCase2<ToDoManagerActivity> {
	...
	public void testRun() {
		...
		solo.enterText((android.widget.EditText) solo
				.getView(harel.com.ToDoList.R.id.title), "t1");
		...
		solo.clickOnView(solo
				.getView(harel.com.ToDoList.R.id.date_picker_button));
		...
		solo.clickOnView(solo
				.getView(harel.com.ToDoList.R.id.time_picker_button));
		...
		assertTrue("DateTimeTest failed:" +
				...
				solo.waitForActivity(
						harel.com.ToDoList.ToDoManagerActivity.class, delay));
